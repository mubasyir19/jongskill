    ...
    <aside className='hidden w-40 lg:w-40 xl:w-72 py-6 lg:flex flex-col justify-between'>
      <div className='mt-9'>
        ...
        <div className='flex flex-col gap-4 pl-2 lg:pl-3 xl:pl-6 mt-10'>
          <Link
            href={`/dashboard`}
            className={`text-white text-xs md:text-sm lg:text-base xl:text-xl font-semibold rounded-l-full flex items-center gap-2 lg:gap-3 xl:gap-6 py-2 lg:py-3 xl:py-5 pl-2 lg:pl-3 xl:pl-5 ${
          ...
          <Link
            ...
            className={`text-white text-xs md:text-sm lg:text-base xl:text-xl font-semibold rounded-l-full flex items-center gap-2 lg:gap-3 xl:gap-6 py-2 lg:py-3 xl:py-5 pl-2 lg:pl-3 xl:pl-5 hover:bg-[var(--color-primary)] transition-all duration- ${
